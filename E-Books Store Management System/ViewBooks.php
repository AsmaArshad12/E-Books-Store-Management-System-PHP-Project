...
<td><a  class="btn btn-success" role="button" href="UpdateBooks.php?id=<?php echo $row['Id']; ?>">Update</a></td>

<td>
<a class="btn btn-success" role="button" href="DeleteBooks.php?id=<?php echo $row['Id']; ?>">Delete</a>
</td>
        </tr>
<?php
}
