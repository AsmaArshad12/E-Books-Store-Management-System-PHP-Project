...
$query="SELECT * FROM clientregistration where Email='$email'and Password='$password'" ;

if(mysqli_query($con, $query))
{

     echo "<script>window.location='ClientHomePage.php';alert('Client Login Successfully');</script>";
}

else
{
    echo "<script>window.location='ClientLogin.php';alert('Invalid Email Or Password');</script>";
}	
...
<body  style="background-color:#6CBCE7">
   ...
   <br><br>
        <div class="container p-3 my-3 bg-white " style="border-radius:15px;width:50%">
             <br>           
<h2 style="color:black;text-align:center;"> Client Login </h2>
   <br>
